...
int main(int argc, char* argv[]) {
	...
	PUNGraph g = TSnap::LoadEdgeList<PUNGraph>("/Users/Narbok009/Desktop/migrafo.txt", 0, 1);
...
void GraphML(PUNGraph graph)
{
	std::ofstream file("/Users/Narbok009/Desktop/grafo.graphml");
	if (file.is_open())
	{
...
void GEXF(PUNGraph graph)
{
	std::ofstream file("/Users/Narbok009/Desktop/grafo.gexf");
	if (file.is_open())
	{
		file << "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n";
...
void GDF(PUNGraph graph)
{
	std::ofstream file("/Users/Narbok009/Desktop/grafo.gdf");
	if (file.is_open())
	{
...
void JSON(PUNGraph graph)
{
	std::ofstream file("/Users/Narbok009/Desktop/grafo.json");
	if (file.is_open())
	{
		file << "{ \"graph\": {\n";
		file << "\"nodes\": [\n";
